                ...
                <DataTable style={{ marginTop: 20, borderBottomWidth: 1 }}>
                    <DataTable.Row style={{ borderWidth: 1 }}>
                        ...
                        <DataTable.Cell
                            ...
                            <ArrowDownIcon name='down' size={18} />
                        </DataTable.Cell>
                    </DataTable.Row>

                    <DataTable.Row style={{ borderWidth: 1 }}>
                        <DataTable.Cell>หลักสูตรที่ 1</DataTable.Cell>
                        <DataTable.Cell
                            style={{
                                alignItems: "center",
                                justifyContent: "center",
                            ...
                            <View
                                ...
                                <Text style={{ color: "white" }}>ใบคำขอฝึกอบรม</Text>
                            </View>
                            </TouchableOpacity>
                        </DataTable.Cell>
                        <DataTable.Cell
                            ...
                            <Text style={{color:'green', fontSize:10}}>อนุมัติ</Text>
                        </DataTable.Cell>
                    </DataTable.Row>
                    <DataTable.Row style={{ borderWidth: 1 }}>
                        <DataTable.Cell>หลักสูตรที่ 2</DataTable.Cell>
                        <DataTable.Cell
                            style={{
                                alignItems: "center",
                                justifyContent: "center",
                        ...
                        <DataTable.Cell
                            ...
                            <Text style={{color:'red', fontSize:10}}>ไม่อนุมัติ</Text>
                        </DataTable.Cell>
                    </DataTable.Row>
                    <DataTable.Row style={{ borderWidth: 1 }}>
                        <DataTable.Cell>หลักสูตรที่ 3</DataTable.Cell>
                        <DataTable.Cell
                            style={{
                                alignItems: "center",
                                justifyContent: "center",
                    ...
                    <DataTable.Row style={{ borderWidth: 1 }}>
                        <DataTable.Cell>หลักสูตรที่ 4</DataTable.Cell>
                        <DataTable.Cell
                            style={{
                                alignItems: "center",
                                justifyContent: "center",
