...
export default class ModalFeedBack extends Component {
    constructor(props) {
     ...
     async saveFeedback(feedback_id){
      ...
      if(answer_text == ''){
          Alert.alert(this.state.lang == "EN" ? "Please enter answer." : "กรุณาใส่ คำตอบ")
      }else{
        var params = {
                              ...
                              return(
                                  <>
                                     <View style={{alignItems: 'flex-start', marginBottom: 5}}>
                                        ...
                                        <Text style={{fontSize: 16 }}>
                                            {this.state.lang === "EN" ? "Course : " : "หลักสูตร : "} {data.course_name}
                                        </Text>
                                        </View>
...

                                        {
                                           ...
                                           <>
                                           <View>
                                           <Label style={{fontSize: 16}}>{this.state.lang === "EN" ? "Answer" : "คำตอบ"}<Label style={{color: 'red'}}>*</Label></Label>
                                           <Textarea value={this.state.note_text}  style={{backgroundColor: '#e6e6e6', borderRadius: 10}} rowSpan={2} 
                                           ...
                                           <Button
                                               ...
                                               onPress={this.saveFeedback.bind(this, data.feedback_id)}
                                           >
                                               <Text style={styles.textStyle}>{this.state.lang === "EN" ? "Reply" : "ตอบ"}</Text>
                                           </Button>
                                           </>
                                        }
