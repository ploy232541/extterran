    ...
    return (
      ...
      >
        <Card containerStyle={{ borderColor: "#398DDD", marginBottom: 30 }}>
          ...
          <Card.Divider />
          <Text>
            {this.state.lang == "EN" ? "Fitsrt name" : "ชื่อ"}
          ...
          <Text>
            {this.state.lang == "EN" ? "Last name" : "นามสกุล"}
            <Label style={{ color: "red" }}>*</Label>
          </Text>
          <TextInput
            style={styles.inputStyle}
          ...
          <Text>
            {this.state.lang == "EN" ? "Phone" : "เบอร์โทรศัพท์"}
            <Label style={{ color: "red" }}>*</Label>
          </Text>
          <TextInput
            style={styles.inputStyle}
          ...
          <Text>
            {this.state.lang == "EN" ? "Email" : "อีเมล"}
            <Label style={{ color: "red" }}>*</Label>
          </Text>
          <TextInput
            style={styles.inputStyle}
          ...
          <Text style={{ marginBottom: 10 }}>
            {this.state.lang == "EN" ? "Problem type" : "ประเภทปัญหา"}
          </Text>
          <Picker
            mode="dropdown"
          ...
          >
            <Picker.Item
              label={this.state.lang === "EN" ? "Please select" : "กรุณาเลือก"}
              value=""
            />
            {this.state.select_1.map((data) => {
              return <Picker.Item label={data.Problem_title} value={data.id} />;
            })}
          </Picker>
          ...
          <Text>
            {this.state.lang == "EN" ? "Upload image" : "อัพโหลดรูปภาพ"}
          </Text>
          <TouchableOpacity
          ...
          >
            ...
            >
              <Text>
                {this.state.lang == "EN" ? "Choose File" : "เลือกรูปภาพ"}
              </Text>
            </View>
          </TouchableOpacity>
