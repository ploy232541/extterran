        ...
        <View style={styles.container}>
            <View style={{ marginHorizontal: 32, marginVertical: 18 }}>
                ...
                <View style={styles.cardCourse}>
                    <View
                        ...
                        <View
                            ...
                            <View style={{ marginTop: 10, marginBottom: 10, width:'80%'}}>
                                <Divider style={{ paddingBottom:1, backgroundColor:'grey'}} />
                            </View>
                    ...
                    <TouchableOpacity style={{alignSelf:'center', marginVertical:20,backgroundColor:'#3b5998', height:HEIGHT*0.035, justifyContent:'center', width:'60%', alignItems:'center',borderRadius:10}}>
...
export default MyInternalCourse
