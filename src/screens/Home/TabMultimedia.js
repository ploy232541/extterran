...
class TabMultimedia extends Component {
    constructor(props) {
        super(props);
        this.state = {
          lang: '',
    ...
    showModal(item){
      ...
      navigation.navigate('MultimediaDetail', {library_type_id: item.library_type_id, title: this.state.lang === "EN" ? item.library_type_name_en : item.library_type_name});
    }
...
export default function(props) {
  ...
  return <TabMultimedia {...props} navigation={navigation} />;
}
