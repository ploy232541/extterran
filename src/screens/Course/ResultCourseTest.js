...
class ResultCourseTest extends Component {
  constructor(props) {
    super(props);
    this.state = {
      lang: "",
        ...
        >
              ...
              <View style={{ alignItems: "center", margin: 40 }}>
                {data.score_past == "y" ? (
                  <View style={{ alignItems: "center" }}>
                    ...
                    >
                      {this.state.lang === "EN" ? "Passed" : "สอบผ่าน"}
                    </Text>
                  </View>
                ) : (
                  <View style={{ alignItems: "center" }}>
                    ...
                    >
                      {this.state.lang === "EN" ? "Fail" : "สอบไม่ผ่าน"}
                    </Text>
                  </View>
                )}
              </View>
          ...
          >
            {result.typeTest == "pre" ? (
              ...
              <View>
                <Text style={{ fontSize: 16, marginBottom: 5 }}>
                  {this.state.lang === "EN"
                    ? "Post course test"
                    : "สอบหลังเรียนหลักสูตร"}
                </Text>
              </View>
            )}

            {result.course.map((data) => {
              return (
            ...
            {result.modelScore.map((data) => {
              return (
                <Text
                  style={{ fontSize: 14, marginBottom: 5, color: "#00b3b3" }}
                >
                  {this.state.lang === "EN"
                    ? "The day of the exam : "
                    : "วันที่ทำข้อสอบ : "}{" "}
                  {moment(data.create_date).format("DD/MM/YYYY h:mm")}
                </Text>
              );
            })}
          ...
          {result.modelScore.map((data) => {
            return (
              <View>
                <View
                  style={{ marginLeft: 30, marginTop: 30, marginBottom: 5 }}
                >
                  <Text style={{ fontSize: 18 }}>
                    {this.state.lang === "EN" ? "Detail" : "รายละเอียด"}
                  </Text>
                </View>
                <View
                  style={{
                ...
                >
                  <View style={{ flexDirection: "row" }}>
                    ...
                    <View style={{ flex: 0.7, alignItems: "flex-end" }}>
                      <Text style={{ fontSize: 16, color: "#000066" }}>
                        {result.full_score}{" "}
                  ...
                  <View style={{ flexDirection: "row" }}>
                    <View style={{ flex: 1 }}>
                      <Text style={{ fontSize: 16 }}>
                        {this.state.lang === "EN" ? "Percent" : "คิดเป็นร้อยละ"}
                      </Text>
                    </View>
                    <View style={{ flex: 0.5, alignItems: "flex-end" }}>
                      <Text style={{ fontSize: 16, color: "#000066" }}>
          ...
          {result.logQues[0].ques_type != 4 ? (
            <View>
              <View style={{ marginLeft: 30, marginTop: 30, marginBottom: 5 }}>
                <Text style={{ fontSize: 18 }}>
                  {this.state.lang === "EN" ? "Total score" : "คะแนนทั้งหมด"}
                </Text>
              </View>
              <View
                style={{
              ...
              >
                ...
                <View style={{ flexDirection: "row", marginTop: 10 }}>
                  <View style={{ flex: 1, marginLeft: 30 }}>
                    <Text style={{ fontSize: 16 }}>
                      {this.state.lang === "EN" ? "Total" : "คะแนนทั้งหมด"}
                    </Text>
                  </View>
                  <View
                    style={{
          ...
          {result.answer != null ? (
            <View>
              <View style={{ marginLeft: 30, marginTop: 30, marginBottom: 10 }}>
                <Text style={{ fontSize: 18 }}>
                  {this.state.lang === "EN" ? "Answer" : "เฉลย"}
                </Text>
              </View>
              <View
                style={{
              ...
              >
                ...
                >
                  ...
                  <View>
                    <Text style={{ fontSize: 16, fontWeight: "bold" }}>
                      {this.state.lang === "EN" ? "Status " : "สถานะ "}
                    </Text>
                  </View>
                </View>
                <Dash
                      ...
                      >
                        ...
                        <View style={{ flex: 1 }}>
                          <View style={{ flex: 1, flexDirection: "column" }}>
                            <Text style={{ fontSize: 14, color: "#000080" }}>
                              {this.state.lang === "EN"
                                ? "Question : "
                                : "คำถาม : "}
                            </Text>
...
export default function (props) {
  ...
  return <ResultCourseTest {...props} navigation={navigation} />;
}
