          ...
          <View
            style={{
...

              {
                  result.typeTest == 'pre' ?
                  <View>
                    <Text style={{fontSize: 16, marginBottom: 5}}>{this.state.lang === "EN" ? 'Pre course test' : 'สอบก่อนเรียนหลักสูตร'}</Text>
                  </View>
                  :
                  <View>
                    <Text style={{fontSize: 16, marginBottom: 5}}>{this.state.lang === "EN" ? 'Post course test' : 'สอบหลังเรียนหลักสูตร'}</Text>
                  </View>
                }
