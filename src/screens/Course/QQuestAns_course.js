  ...
  onPressSubmit = async () => {
    ...
    const params = {
      ...
      choice: {
        input: input,
        radio: radio,
        checkbox: checkbox.length > 0 ? checkbox : null,
        text: text,
            ...
            {questionnaire != null ? (
              <View>
                ...
                <Text style={{ fontSize: 14 }}>
                  {this.removeTags(decode(questionnaire.survey.instructions))}{" "}
                </Text>
                <View
                  style={{
                    height: 1,
